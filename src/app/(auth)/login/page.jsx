    ...
    <div className="flex flex-col lg:flex-row justify-center gap-5 items-center bg-[#614c22] w-[90%] md:w-[50%] mx-auto mt-20 rounded-2xl border border-[#2F2D2A]/20 shadow-xl overflow-hidden mb-20">
      <div className="text-white space-y-5 bg-[#F4E7D3] p-10 w-full md:w-[40%] self-stretch flex flex-col justify-center">
        ...
        <p className="text-[#2F2D2A] italic">
          Please log in to your account to manage your pets and connect with
          other pet lovers. We are excited to have you back!
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg py-20 px-10 w-full md:w-[60%]">
        ...
        >
          <TextField isRequired name="email" type="email">
            <Label className="text-[#2F2D2A] font-semibold mb-2">Email</Label>

            <Input placeholder="john@example.com" className="text-black" />
          ...
          <TextField isRequired minLength={8} name="password" type="password">
            ...
            <Input placeholder="Enter your password" className="text-black" />
          ...
          <div>
            <p className="text-center text-[#2F2D2A]">Or continue with</p>
